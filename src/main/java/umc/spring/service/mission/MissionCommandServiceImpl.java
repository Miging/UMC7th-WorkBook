...
public class MissionCommandServiceImpl implements MissionCommandService {
    ...
    public MemberMission challengeMission(Long storeId, Long missionId, Long memberId) {
        Mission mission=missionRepository.findById(missionId).orElseThrow(()->new ReviewException(ErrorStatus.MISSION_NOT_FOUND));
        Member member=memberRepository.findById(memberId).orElseThrow(()->new ReviewException(ErrorStatus.MEMBER_NOT_FOUND));
